...
export const usePushNotifications = () => {
  ...
  useEffect(() => {
    ...
    const checkInit = () => {
      ...
      if (OneSignalHelper.isAvailable()) {
        ...
        console.error(
          "❌ usePushNotifications: OneSignal failed to initialize after 10 seconds"
        );
        setState((prev) => ({
          ...prev,
          loading: false,
  ...
  useEffect(() => {
    ...
    const cleanup = OneSignalHelper.addSubscriptionChangeListener(
