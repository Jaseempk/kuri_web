...
export function ProfileHeaderSection({ profile, totalCircles = 0 }: ProfileHeaderSectionProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl p-6 mx-4 mt-6 shadow-lg md:bg-gradient-to-br md:from-primary/20 md:to-accent/20 md:p-8 lg:p-12 md:mt-8 relative overflow-hidden"
    >
