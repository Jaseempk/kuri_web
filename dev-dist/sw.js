...
define(['./workbox-41f5f610'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/indexer\.dev\.hyperindex\.xyz\//, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/\/images\/.*\.(png|jpg|jpeg|svg|gif)$/, new workbox.CacheFirst({
    "cacheName": "images",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 30,
